...
public class MyMessageSendFragment extends Fragment {
    ...
    public MyMessageSendFragment() {
    }

    public static MyMessageSendFragment newInstance(int initValue) {
        MyMessageSendFragment message_send_fragment = new MyMessageSendFragment();
        return message_send_fragment;
    }
    ...
    //보낸 쪽지를 불러오는 async
    public class AsyncSend extends AsyncTask<Boolean, Integer, ArrayList<MymessageEntityObject>> {
        ...
        protected ArrayList<MymessageEntityObject> doInBackground(
            ...
            String targetURL = String.format(NetworkDefineConstant.SERVER_URL_MYMESSAGE_SEND) + "/" + userId;
            ...
            try {
                ...
                if (flag) {
                    return ParseDataParseHandler.getJSONSendMessagetList(
        ...
        protected void onPostExecute(ArrayList<MymessageEntityObject> result) {
            ...
            if (result != null && result.size() >= 0) {
                SubActivity_Myinfo_Message_SendAdapter subActivity_myinfo_message_sendAdapter =
                        new SubActivity_Myinfo_Message_SendAdapter(owner, result);
                rv.setAdapter(subActivity_myinfo_message_sendAdapter);
                subActivity_myinfo_message_sendAdapter.notifyDataSetChanged();
            } else {
    ...
    public class RegditDriverDelete extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... writeId) {
            Response response = null;
            String targetURL = String.format(NetworkDefineConstant.SERVER_URL_MYMESSAGE_SEND_DELETE);
...
//            relativeLayout.setVisibility(View.VISIBLE);
    ...
    public class SubActivity_Myinfo_Message_SendAdapter extends RecyclerView.Adapter<SubActivity_Myinfo_Message_SendAdapter.ViewHolder> {
        public ArrayList<MymessageEntityObject> messageEntitySendObjects;
        Context context;
        View popupView;
        ...
        public SubActivity_Myinfo_Message_SendAdapter(Context context, ArrayList<MymessageEntityObject> resources) {
            this.messageEntitySendObjects = resources;
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            final MymessageEntityObject messageEntitySendObject = messageEntitySendObjects.get(position);
            k = messageEntitySendObject.messageid;
            holder.borReply.setVisibility(View.GONE);
            ...
            holder.borNickName.setText(messageEntitySendObject.receiver_nick);
            holder.Text.setText(messageEntitySendObject.message);
            holder.Date.setText(messageEntitySendObject.date);

            int schoolNum = messageEntitySendObject.school;
            ...
            if (schoolNum == 10) {
                ...
                Glide.with(owner).load(R.drawable.openuniv).into(holder.NickImg);
        ...
        public int getItemCount() {
            return messageEntitySendObjects.size();
        }
        ...
        public void showPopupReply(View v) {
            ...
            msgSendText.setText("답장하시겠습니까?");
            btnDelete.setText("취소");
            btnAnswer.setText("답장");
            ...
            btnAnswer.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("receiveNick", nickname);

                    Log.i("nickname3", nickname);
